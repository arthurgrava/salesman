...
def get_file_string(neighbors):
    ...
    string = string + 'similarity.path=/home/arthur/data/normalized/timed-social-similarity.csv\n'
    string = string + 'similarities.path=/home/arthur/data/normalized/authors_similarity_24.csv\n'
    string = string + 'means.path=/home/arthur/data/normalized/authors_means_24.csv\n'
    string = string + 'target.path=/home/arthur/data/results_2/{}_neighbors/srs_star_recommendations.csv\n'.format(neighbors)
...
def run():
    for n in NEIGHBORS:
        ...
        path = '{}/{}_neighbors/srs.properties'.format(
            BASE,
            n
        )
