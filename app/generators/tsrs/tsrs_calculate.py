...
def get_file_string(neighbors):
    ...
    string = string + 'similarity.path=/home/arthur/data/normalized/trust_coauthors_2.csv\n'
    string = string + 'means.path=/home/arthur/data/normalized/authors_means_24.csv\n'
    string = string + 'target.path=/home/arthur/data/results_2/{}_neighbors/tsrs_recommendations.csv\n'.format(neighbors)
...
def run():
    for n in NEIGHBORS:
        ...
        path = '{}/{}_neighbors/tsrs.properties'.format(
            BASE,
            n
        )
